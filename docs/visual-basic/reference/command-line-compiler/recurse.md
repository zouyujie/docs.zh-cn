...
## 示例  
 下面的代码编译当前目录中的所有 [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] 文件。  
  
```  
vbc *.vb  
```  
  
 下面的代码编译 `Test\ABC` 目录以及其下任何目录中的所有 [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] 文件，然后生成 `Test.ABC.dll`。  
