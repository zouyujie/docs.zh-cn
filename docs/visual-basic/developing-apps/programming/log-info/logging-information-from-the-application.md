...
|更改 `My.Application.Log` 写入信息的目标位置。|[演练：更改 My.Application.Log 写入信息的位置](../Topic/Walkthrough:%20Changing%20Where%20My.Application.Log%20Writes%20Information%20\(Visual%20Basic\).md)|  
