...
-   **查找**。 可以查询和修改流中的位置。  
 ...
 有关详细信息，请参阅 [Composing Streams](../Topic/Composing%20Streams.md)。  
  
## <a name="types-of-streams"></a>流的类型  
 在 [!INCLUDE[dnprdnshort](../../../../csharp/getting-started/includes/dnprdnshort-md.md)] 中，流由 <xref:System.IO.Stream> 类表示，这形成了所有其他流的抽象类。 不能直接创建 <xref:System.IO.Stream> 类的实例，但必须使用它执行的一个类。  
