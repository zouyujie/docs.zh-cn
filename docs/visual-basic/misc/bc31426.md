...
条件编译表达式引用非内部类型，但仅允许使用内部类型。  
 ...
 有关 [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] 中内部类型的详细信息，请参阅 [数据类型摘要](../../visual-basic/language-reference/keywords/data-types-summary.md)。  
