...
[!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] 编译器调用程序集链接器（Al.exe，也称作 Alink）生成包含清单的程序集。 创建程序集后，在对其进行签发时，链接器报告错误。 可能是由无效密钥造成的。  
