...
*默认属性* 是您的代码可以访问，而无需指定它的类或结构属性。  当调用命名为类或结构，但不是特性时，因此，上下文允许访问属性的访问， [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] 解析对该类或结构的默认属性的访问，如果存在\)。  
