...
[!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] 提供了一组预定义数据类型，这些数据类型可用于许多编程元素。  本节描述这些类型及其用法。  
...
## 相关章节  
 ...
 概述 [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] 提供的基本数据类型。