...
```  
 ...
 有关数据类型的更多信息，请参见 [数据类型](../../../../visual-basic/reference/command-line-compiler/index.md)。  有关对象的更多信息，请参见[对象和类](../../../../visual-basic/reference/command-line-compiler/index.md)和[使用组件编程](../Topic/Programming%20with%20Components.md)。  
...
## 请参阅  
 [如何：创建新变量](../Topic/How%20to:%20Create%20a%20New%20Variable%20\(Visual%20Basic\).md)   
