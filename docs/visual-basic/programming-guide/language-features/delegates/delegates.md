...
|标题|说明|  
|--------|--------|  
|[如何：调用委托方法](../Topic/How%20to:%20Invoke%20a%20Delegate%20Method%20\(Visual%20Basic\).md)|提供一个示例，该示例演示如何将方法与委托关联，然后通过委托调用该方法。|  
|[如何：在 Visual Basic 中将过程传递给另一过程](../Topic/How%20to:%20Pass%20Procedures%20to%20Another%20Procedure%20in%20Visual%20Basic.md)|演示如何使用委托将一个过程传递到另一个过程。|  
