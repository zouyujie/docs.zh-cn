...
本主题简要介绍 Visual Basic 中的[!INCLUDE[vbteclinqext](../../../../csharp/programming-guide/concepts/linq/includes/vbteclinqext_md.md)] 表达式，以及您在查询中执行的一些典型类型的运算。  有关更多信息，请参见下列主题：  
