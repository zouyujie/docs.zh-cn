...
本节包含可帮助您理解和使用 Visual Basic 和[!INCLUDE[vbteclinqext](../../../../csharp/getting-started/includes/vbteclinqext-md.md)] 的概述、示例和背景信息。  
...
## 相关章节  
 ...
 概述 [!INCLUDE[vbteclinq](../../../../csharp/includes/vbteclinq-md.md)] 中的查询并提供指向其他资源的链接。  
 ...
 包括有关对内存中集合使用 [!INCLUDE[vbteclinq](../../../../csharp/includes/vbteclinq-md.md)] 的一组帮助主题。  
  
 [LINQ to XML](../../../../visual-basic/programming-guide/concepts/linq/linq-to-xml.md)  
 包括指向说明如何使用 LINQ to XML 的主题的链接，此功能可提供文档对象模型 \(DOM\) 的内存中文档修改功能，并且支持 LINQ 查询表达式。  
  
 [LINQ 示例](../Topic/LINQ%20Samples.md)  
 提供指向阐述 [!INCLUDE[vbteclinq](../../../../csharp/includes/vbteclinq-md.md)] 示例的主题的链接。  
  
 [LINQ \(Language\-Integrated Query\)](../Topic/LINQ%20\(Language-Integrated%20Query\).md)  
 提供指向阐述 [!INCLUDE[vbteclinq](../../../../csharp/includes/vbteclinq-md.md)] 技术的主题的链接。