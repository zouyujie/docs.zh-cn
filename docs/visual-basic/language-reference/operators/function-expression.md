...
## 示例  
 Lambda 表达式是 [!INCLUDE[vbteclinqext](../../../csharp/programming-guide/concepts/linq/includes/vbteclinqext_md.md)] 中的许多查询运算符的基础，可以在基于方法的查询中显式使用。  下面的示例演示一个典型的 [!INCLUDE[vbteclinq](../../../csharp/includes/vbteclinq_md.md)] 查询，后跟该查询到方法格式的转换。  
