...
`Microsoft.VisualBasic` 命名空间包含构成 [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] 运行库的类、模块、常数和枚举。  这些库成员提供可在代码中使用的过程、属性和常数值。  每个模块和类都表示一个特定的功能类别。  
...
## Microsoft.VisualBasic 常数和枚举  
 `Microsoft.VisualBasic` 命名空间提供常数和枚举作为 [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] 运行库的一部分。  您可以在代码中使用这些常数值。  每个枚举都表示一个特定的功能类别。  有关更多信息，请参见 [常量和枚举](../../visual-basic/language-reference/constants-and-enumerations.md)。  
