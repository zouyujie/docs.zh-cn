---
title: "Visual Basic 运行库成员 | Microsoft Docs"
ms.date: "2015-07-20"
ms.prod: ".net"
ms.technology: 
...
`Microsoft.VisualBasic` 命名空间包含构成 [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] 运行库的类、模块、常数和枚举。  这些库成员提供可在代码中使用的过程、属性和常数值。  每个模块和类都表示一个特定的功能类别。  
  
## Microsoft.VisualBasic.Collection 类  
...
## Microsoft.VisualBasic.ComClassAttribute 类  
...
## Microsoft.VisualBasic.ControlChars 类  
...
## Microsoft.VisualBasic.Constants 类  
...
## Microsoft.VisualBasic.Conversion 模块  
...
## Microsoft.VisualBasic.DateAndTime 模块  
...
## Microsoft.VisualBasic.ErrObject 类  
...
## Microsoft.VisualBasic.FileSystem 模块  
...
## Microsoft.VisualBasic.Financial 模块  
...
## Microsoft.VisualBasic.Globals 模块  
...
## Microsoft.VisualBasic.HideModuleNameAttribute 类  
  
|||||  
|-|-|-|-|  
|<xref:Microsoft.VisualBasic.HideModuleNameAttribute>||||  
  
## Microsoft.VisualBasic.Information 模块  
...
## Microsoft.VisualBasic.Interaction 模块  
...
## Microsoft.VisualBasic.MyGroupCollectionAttribute 类  
...
## Microsoft.VisualBasic.Strings 模块  
...
## Microsoft.VisualBasic.VBFixedArrayAttribute 类  
  
|||||  
|-|-|-|-|  
|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Bounds%2A>|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Length%2A>|||  
  
## Microsoft.VisualBasic.VBFixedStringAttribute 类  
  
|||||  
|-|-|-|-|  
|<xref:Microsoft.VisualBasic.VBFixedStringAttribute.Length%2A>||||  
  
## Microsoft.VisualBasic.VbMath 模块  
  
|||||  
|-|-|-|-|  
|<xref:Microsoft.VisualBasic.VBMath.Randomize%2A>|<xref:Microsoft.VisualBasic.VBMath.Rnd%2A>|||  
  
## Microsoft.VisualBasic 常数和枚举  
 `Microsoft.VisualBasic` 命名空间提供常数和枚举作为 [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] 运行库的一部分。  您可以在代码中使用这些常数值。  每个枚举都表示一个特定的功能类别。  有关更多信息，请参见 [常量和枚举](../../visual-basic/language-reference/constants-and-enumerations.md)。  
