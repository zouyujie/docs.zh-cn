...
使用 [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] 可以在代码中创建[!INCLUDE[vbteclinqext](../../../csharp/programming-guide/concepts/linq/includes/vbteclinqext_md.md)] 表达式。  
