...
[!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] 提供了多种允许对象与非托管代码交互操作的特性，并提供了一个无需模块名称即可访问模块成员的特性。  下表列出了 [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] 使用的特性。  
