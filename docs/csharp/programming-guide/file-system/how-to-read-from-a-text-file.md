...
> [!NOTE]
>  本示例的文件在主题 [如何：写入文本文件](../Topic/How%20to:%20Write%20to%20a%20Text%20File%20\(C%23%20Programming%20Guide\).md)创建。  
...
## 编译代码  
 ...
 如果不使用从 [如何：写入文本文件](../Topic/How%20to:%20Write%20to%20a%20Text%20File%20\(C%23%20Programming%20Guide\).md)的文本文件，请替换为您计算机上的参数。`ReadAllText` 和 `ReadAllLines` 使用适当的路径和文件名。  
