...
## Main 方法  
 ...
 `Main` 方法是驻留在类或结构内的 [static](../../../visual-basic/language-reference/modifiers/static.md)方法。  在前面的“Hello World\!”示例中，此方法驻留在一个名为 `Hello` 的类中。  可以用下列方式之一声明 `Main` 方法：  
...
2.  执行以下步骤之一打开命令提示符窗口：  
    ...
    -   从标准“命令提示”窗口启用命令行生成。  
         ...
         请参见 [How to: Set Environment Variables for the Visual Studio Command Line](../Topic/How%20to:%20Set%20Environment%20Variables%20for%20the%20Visual%20Studio%20Command%20Line.md)。  
