...
“event”: 事件必须是委托类型  
 ...
 事件关键字需要[委托](../../csharp/language-reference/keywords/delegate.md)类型。 有关详细信息，请参阅[事件](../../csharp/programming-guide/events/index.md)和[委托](../../visual-basic/reference/command-line-compiler/index.md)。  
