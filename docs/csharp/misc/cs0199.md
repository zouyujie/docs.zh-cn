...
无法向静态只读字段“name”的字段传递 ref 或 out（在静态构造函数中除外）  
 ...
 一个 [readonly](../../visual-basic/language-reference/modifiers/readonly.md) 变量必须与构造函数具有相同的 [静态](../../visual-basic/language-reference/modifiers/static.md)用法，在此构造函数中你要将其作为 [ref](../../csharp/language-reference/keywords/ref.md) 或 [out](../../csharp/language-reference/keywords/out.md) 参数传递。 有关详细信息，请参阅[传递参数](../../csharp/programming-guide/classes-and-structs/passing-parameters.md)。  
