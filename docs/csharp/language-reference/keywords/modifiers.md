...
|[readonly](../../../visual-basic/language-reference/modifiers/readonly.md)|声明一个字段，该字段只能赋值为该声明的一部分或者在同一个类的构造函数中。|  
|[sealed](../../../csharp/language-reference/keywords/sealed.md)|指定无法继承类。|  
|[static](../../../visual-basic/language-reference/modifiers/static.md)|声明属于类型本身而不是特定对象的成员。|  
