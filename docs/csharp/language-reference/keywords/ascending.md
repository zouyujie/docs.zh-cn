---
title: "ascending（C# 参考） | Microsoft Docs"
ms.custom: ""
ms.date: "12/03/2016"
...
`ascending` 上下文关键字用在查询表达式的 [orderby 子句](../../../csharp/language-reference/keywords/orderby-clause.md)中，用于指定从最小到最大的排序顺序。  因为 `ascending` 是默认排序顺序，所以您无须指定它。  
  
## 示例  
 下面的示例演示 `ascending` 在 [orderby 子句](../../../csharp/language-reference/keywords/orderby-clause.md)中的用法。  
