...
|上下文|备注|  
|---------|--------|  
|[类](../../../standard/base-types/classes.md)|类类型的直接基类必须至少与类类型本身具有同样的可访问性。|  
|[接口](../../../csharp/programming-guide/interfaces/index.md)|接口类型的显式基接口必须至少与接口类型本身具有同样的可访问性。|  
|[委托](../../../visual-basic/reference/command-line-compiler/index.md)|委托类型的返回类型和参数类型必须至少与委托类型本身具有同样的可访问性。|  
...
|[索引器](../../../visual-basic/reference/command-line-compiler/index.md)|索引器的类型和参数类型必须至少与索引器本身具有同样的可访问性。|  
