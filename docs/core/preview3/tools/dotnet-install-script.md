...
#<a name="dotnet-install-scripts-reference-net-core-tools-rc4"></a>dotnet-install 脚本参考（.NET Core 工具 RC4）

> [!WARNING]
> 本主题适用于 .NET Core 工具 RC4。 对于 .NET Core 工具预览版 2，请参阅 [dotnet-install 脚本引用](../../tools/dotnet-install-script.md)主题。
