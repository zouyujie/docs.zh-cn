...
# <a name="net-core-tools-telemetry-net-core-tools-rc4"></a>.NET Core 工具遥测（.NET Core 工具 RC4）

> [!WARNING]
> 本主题适用于 .NET Core 工具 RC4。 对于 .NET Core 工具预览版 2，请参阅 [.NET Core 工具遥测](../../tools/telemetry.md)主题。
